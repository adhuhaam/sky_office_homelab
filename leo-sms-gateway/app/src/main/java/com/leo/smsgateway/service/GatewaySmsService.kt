package com.leo.smsgateway.service
...
import com.leo.smsgateway.LeoSmsGatewayApp.Companion.CHANNEL_SERVICE
import com.leo.smsgateway.MainActivity
import com.leo.smsgateway.R
...
import com.leo.smsgateway.data.remote.dto.HeartbeatHubDto
import com.leo.smsgateway.data.remote.dto.HeartbeatRequest
import com.leo.smsgateway.data.remote.dto.SendSmsHubRequest
import com.leo.smsgateway.data.remote.dto.SmsResultHubDto
            ...
            if (hub?.connectionState == HubConnectionState.CONNECTED) {
                hub.send(
                    ...
                    HeartbeatHubDto(
                        ...
                        appVersion = com.leo.smsgateway.BuildConfig.VERSION_NAME,
                    ),
                )
            } else {
